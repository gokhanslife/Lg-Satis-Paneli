...
# --- CSS: FORM KUTU İÇİ YAZILARI BEYAZ YAPILDI ---
st.markdown("""
    <style>
    /* Form kutularının içindeki yazı rengini BEYAZ yap */
    ...
    /* Metrik başlıklarını kalın yap */
    [data-testid="stMetricLabel"] p {
        font-weight: 900 !important;
    }

    /* Metrik değerlerini LG kırmızısında tut */
